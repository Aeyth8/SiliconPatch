...
public:
	...
	int32                                         TextureCoordinateCount;                            // 0x0338(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_33C[0xF8];                                     // 0x033C(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PendingCompactCounter;                             // 0x0434(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SubdivisionCount;                                  // 0x0438(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_43C[0x1E4];                                    // 0x043C(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEditableMesh) == 0x000620, "Wrong size on UEditableMesh");
static_assert(offsetof(UEditableMesh, Adapters) == 0x000328, "Member 'UEditableMesh::Adapters' has a wrong offset!");
static_assert(offsetof(UEditableMesh, TextureCoordinateCount) == 0x000338, "Member 'UEditableMesh::TextureCoordinateCount' has a wrong offset!");
static_assert(offsetof(UEditableMesh, PendingCompactCounter) == 0x000434, "Member 'UEditableMesh::PendingCompactCounter' has a wrong offset!");
static_assert(offsetof(UEditableMesh, SubdivisionCount) == 0x000438, "Member 'UEditableMesh::SubdivisionCount' has a wrong offset!");
