...
static_assert(sizeof(MediaPlayer_OpenSourceWithOptions) == 0x000028, "Wrong size on MediaPlayer_OpenSourceWithOptions");
...
static_assert(offsetof(MediaPlayer_OpenSourceWithOptions, ReturnValue) == 0x000024, "Member 'MediaPlayer_OpenSourceWithOptions::ReturnValue' has a wrong offset!");
