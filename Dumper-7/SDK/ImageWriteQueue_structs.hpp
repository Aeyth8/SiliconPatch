...
public:
	...
	TDelegate<void(bool bSuccess)>                OnComplete;                                        // 0x0008(0x0010)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, NativeAccessSpecifierPublic)
