...
// Function AugmentedReality.ARPointCloudComponent.SetIsVisible
// 0x0001 (0x0001 - 0x0000)
struct ARPointCloudComponent_SetIsVisible final
{
public:
...
static_assert(alignof(ARPointCloudComponent_SetIsVisible) == 0x000001, "Wrong alignment on ARPointCloudComponent_SetIsVisible");
static_assert(sizeof(ARPointCloudComponent_SetIsVisible) == 0x000001, "Wrong size on ARPointCloudComponent_SetIsVisible");
static_assert(offsetof(ARPointCloudComponent_SetIsVisible, bNewVisibility) == 0x000000, "Member 'ARPointCloudComponent_SetIsVisible::bNewVisibility' has a wrong offset!");

// Function AugmentedReality.ARPointCloudComponent.SetPointCloud
// 0x0010 (0x0010 - 0x0000)
struct ARPointCloudComponent_SetPointCloud final
{
public:
...
static_assert(alignof(ARPointCloudComponent_SetPointCloud) == 0x000008, "Wrong alignment on ARPointCloudComponent_SetPointCloud");
static_assert(sizeof(ARPointCloudComponent_SetPointCloud) == 0x000010, "Wrong size on ARPointCloudComponent_SetPointCloud");
static_assert(offsetof(ARPointCloudComponent_SetPointCloud, Points) == 0x000000, "Member 'ARPointCloudComponent_SetPointCloud::Points' has a wrong offset!");

// Function AugmentedReality.ARPointCloudComponent.SetPointColor
// 0x0010 (0x0010 - 0x0000)
struct ARPointCloudComponent_SetPointColor final
{
public:
...
static_assert(alignof(ARPointCloudComponent_SetPointColor) == 0x000004, "Wrong alignment on ARPointCloudComponent_SetPointColor");
static_assert(sizeof(ARPointCloudComponent_SetPointColor) == 0x000010, "Wrong size on ARPointCloudComponent_SetPointColor");
static_assert(offsetof(ARPointCloudComponent_SetPointColor, Color) == 0x000000, "Member 'ARPointCloudComponent_SetPointColor::Color' has a wrong offset!");

// Function AugmentedReality.ARPointCloudComponent.SetPointSize
// 0x0004 (0x0004 - 0x0000)
struct ARPointCloudComponent_SetPointSize final
{
public:
...
static_assert(alignof(ARPointCloudComponent_SetPointSize) == 0x000004, "Wrong alignment on ARPointCloudComponent_SetPointSize");
static_assert(sizeof(ARPointCloudComponent_SetPointSize) == 0x000004, "Wrong size on ARPointCloudComponent_SetPointSize");
static_assert(offsetof(ARPointCloudComponent_SetPointSize, Size) == 0x000000, "Member 'ARPointCloudComponent_SetPointSize::Size' has a wrong offset!");

// Function AugmentedReality.ARPointCloudComponent.GetPointsInBox
// 0x0030 (0x0030 - 0x0000)
struct ARPointCloudComponent_GetPointsInBox final
{
public:
	struct FBox                                   WorldSpaceBox;                                     // 0x0000(0x001C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(alignof(ARPointCloudComponent_GetPointsInBox) == 0x000008, "Wrong alignment on ARPointCloudComponent_GetPointsInBox");
static_assert(sizeof(ARPointCloudComponent_GetPointsInBox) == 0x000030, "Wrong size on ARPointCloudComponent_GetPointsInBox");
static_assert(offsetof(ARPointCloudComponent_GetPointsInBox, WorldSpaceBox) == 0x000000, "Member 'ARPointCloudComponent_GetPointsInBox::WorldSpaceBox' has a wrong offset!");
static_assert(offsetof(ARPointCloudComponent_GetPointsInBox, ReturnValue) == 0x000020, "Member 'ARPointCloudComponent_GetPointsInBox::ReturnValue' has a wrong offset!");

// Function AugmentedReality.ARPointCloudComponent.GetPointsOutsideBox
// 0x0030 (0x0030 - 0x0000)
struct ARPointCloudComponent_GetPointsOutsideBox final
{
public:
	struct FBox                                   WorldSpaceBox;                                     // 0x0000(0x001C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(ARPointCloudComponent_GetPointsOutsideBox) == 0x000008, "Wrong alignment on ARPointCloudComponent_GetPointsOutsideBox");
static_assert(sizeof(ARPointCloudComponent_GetPointsOutsideBox) == 0x000030, "Wrong size on ARPointCloudComponent_GetPointsOutsideBox");
static_assert(offsetof(ARPointCloudComponent_GetPointsOutsideBox, WorldSpaceBox) == 0x000000, "Member 'ARPointCloudComponent_GetPointsOutsideBox::WorldSpaceBox' has a wrong offset!");
static_assert(offsetof(ARPointCloudComponent_GetPointsOutsideBox, ReturnValue) == 0x000020, "Member 'ARPointCloudComponent_GetPointsOutsideBox::ReturnValue' has a wrong offset!");
