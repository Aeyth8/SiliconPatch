...
// BlueprintGeneratedClass BP_NPC_EnemySentry_climbin.BP_NPC_EnemySentry_Climbin_C
// 0x0190 (0x0A40 - 0x08B0)
class ABP_NPC_EnemySentry_Climbin_C final : public ABP_NPC_Base_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_NPC_EnemySentry_Climbin_C;       // 0x08B0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	void ExecuteUbergraph_BP_NPC_EnemySentry_Climbin(int32 EntryPoint);
	void Init();
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_NPC_EnemySentry_Climbin_C">();
	}
	static class ABP_NPC_EnemySentry_Climbin_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_NPC_EnemySentry_Climbin_C>();
	}
};
static_assert(alignof(ABP_NPC_EnemySentry_Climbin_C) == 0x000010, "Wrong alignment on ABP_NPC_EnemySentry_Climbin_C");
static_assert(sizeof(ABP_NPC_EnemySentry_Climbin_C) == 0x000A40, "Wrong size on ABP_NPC_EnemySentry_Climbin_C");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, UberGraphFrame_BP_NPC_EnemySentry_Climbin_C) == 0x0008B0, "Member 'ABP_NPC_EnemySentry_Climbin_C::UberGraphFrame_BP_NPC_EnemySentry_Climbin_C' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, BrokenMesh) == 0x0008B8, "Member 'ABP_NPC_EnemySentry_Climbin_C::BrokenMesh' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, HitReactionTime) == 0x0008C0, "Member 'ABP_NPC_EnemySentry_Climbin_C::HitReactionTime' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, HitReactionTimeCurrent) == 0x0008C4, "Member 'ABP_NPC_EnemySentry_Climbin_C::HitReactionTimeCurrent' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AttackSpeed) == 0x0008C8, "Member 'ABP_NPC_EnemySentry_Climbin_C::AttackSpeed' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AttackSpeedMax) == 0x0008D0, "Member 'ABP_NPC_EnemySentry_Climbin_C::AttackSpeedMax' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, SwitchCoverTimeMin) == 0x0008D8, "Member 'ABP_NPC_EnemySentry_Climbin_C::SwitchCoverTimeMin' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, SwitchCoverTimeMax) == 0x0008E0, "Member 'ABP_NPC_EnemySentry_Climbin_C::SwitchCoverTimeMax' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsInitSettings) == 0x0008E8, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsInitSettings' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AttackSpeed_Min_) == 0x0008EC, "Member 'ABP_NPC_EnemySentry_Climbin_C::AttackSpeed_Min_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AttackSpeed_Max_) == 0x0008F0, "Member 'ABP_NPC_EnemySentry_Climbin_C::AttackSpeed_Max_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, SwitchCoverInterval_Min_) == 0x0008F4, "Member 'ABP_NPC_EnemySentry_Climbin_C::SwitchCoverInterval_Min_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, SwitchCoverInterval_Max_) == 0x0008F8, "Member 'ABP_NPC_EnemySentry_Climbin_C::SwitchCoverInterval_Max_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsHeadShotDead) == 0x0008FC, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsHeadShotDead' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, HitTransition) == 0x0008FD, "Member 'ABP_NPC_EnemySentry_Climbin_C::HitTransition' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, DodgeRate) == 0x000900, "Member 'ABP_NPC_EnemySentry_Climbin_C::DodgeRate' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, DodgeCD_Min_) == 0x000904, "Member 'ABP_NPC_EnemySentry_Climbin_C::DodgeCD_Min_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, DodgeCD_Max_) == 0x000908, "Member 'ABP_NPC_EnemySentry_Climbin_C::DodgeCD_Max_' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsAimMe) == 0x00090C, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsAimMe' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsPlayDodge) == 0x00090D, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsPlayDodge' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, RunHurtAM) == 0x000910, "Member 'ABP_NPC_EnemySentry_Climbin_C::RunHurtAM' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, CrouchHurtAM) == 0x000920, "Member 'ABP_NPC_EnemySentry_Climbin_C::CrouchHurtAM' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, StandHurtAM) == 0x000930, "Member 'ABP_NPC_EnemySentry_Climbin_C::StandHurtAM' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, FireAM) == 0x000940, "Member 'ABP_NPC_EnemySentry_Climbin_C::FireAM' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, ReloadAM) == 0x000950, "Member 'ABP_NPC_EnemySentry_Climbin_C::ReloadAM' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AimPitch) == 0x000960, "Member 'ABP_NPC_EnemySentry_Climbin_C::AimPitch' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, DTime) == 0x000964, "Member 'ABP_NPC_EnemySentry_Climbin_C::DTime' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, AnimBP) == 0x000968, "Member 'ABP_NPC_EnemySentry_Climbin_C::AnimBP' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, MiniBreakThreshold) == 0x000970, "Member 'ABP_NPC_EnemySentry_Climbin_C::MiniBreakThreshold' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, MaxBreakThreshold) == 0x000974, "Member 'ABP_NPC_EnemySentry_Climbin_C::MaxBreakThreshold' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsMoving) == 0x000978, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsMoving' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsHurting) == 0x000979, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsHurting' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsReloading) == 0x00097A, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsReloading' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, State) == 0x00097C, "Member 'ABP_NPC_EnemySentry_Climbin_C::State' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, MoveTargetLocation) == 0x000980, "Member 'ABP_NPC_EnemySentry_Climbin_C::MoveTargetLocation' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, ShouldAttack) == 0x00098C, "Member 'ABP_NPC_EnemySentry_Climbin_C::ShouldAttack' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, RandomCount) == 0x000990, "Member 'ABP_NPC_EnemySentry_Climbin_C::RandomCount' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, Timespan) == 0x000994, "Member 'ABP_NPC_EnemySentry_Climbin_C::Timespan' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsCrouch) == 0x000998, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsCrouch' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, Waypoint) == 0x0009A0, "Member 'ABP_NPC_EnemySentry_Climbin_C::Waypoint' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsShowWayPoint) == 0x0009B0, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsShowWayPoint' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, FreshWayPointTime) == 0x0009B4, "Member 'ABP_NPC_EnemySentry_Climbin_C::FreshWayPointTime' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, CheckAvoid) == 0x0009B8, "Member 'ABP_NPC_EnemySentry_Climbin_C::CheckAvoid' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, FixedTargetLocation) == 0x0009BC, "Member 'ABP_NPC_EnemySentry_Climbin_C::FixedTargetLocation' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, ShootAvoid) == 0x0009C8, "Member 'ABP_NPC_EnemySentry_Climbin_C::ShootAvoid' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, LastLocation) == 0x0009CC, "Member 'ABP_NPC_EnemySentry_Climbin_C::LastLocation' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, MovingStuckCheckTime) == 0x0009D8, "Member 'ABP_NPC_EnemySentry_Climbin_C::MovingStuckCheckTime' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, GoToStartPathCheckTime) == 0x0009DC, "Member 'ABP_NPC_EnemySentry_Climbin_C::GoToStartPathCheckTime' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, DeathCheck) == 0x0009E0, "Member 'ABP_NPC_EnemySentry_Climbin_C::DeathCheck' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, TempTargetLocation) == 0x0009E4, "Member 'ABP_NPC_EnemySentry_Climbin_C::TempTargetLocation' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsFirstSwitch) == 0x0009F0, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsFirstSwitch' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsAllowRollOffset) == 0x0009F1, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsAllowRollOffset' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, FireInterval) == 0x0009F4, "Member 'ABP_NPC_EnemySentry_Climbin_C::FireInterval' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsForceStop) == 0x0009F8, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsForceStop' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, HitCount) == 0x0009FC, "Member 'ABP_NPC_EnemySentry_Climbin_C::HitCount' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, ForceStopCheck) == 0x000A00, "Member 'ABP_NPC_EnemySentry_Climbin_C::ForceStopCheck' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, BulletReloadCount) == 0x000A04, "Member 'ABP_NPC_EnemySentry_Climbin_C::BulletReloadCount' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsStartAimRoll) == 0x000A08, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsStartAimRoll' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, NewVar_0_0) == 0x000A0C, "Member 'ABP_NPC_EnemySentry_Climbin_C::NewVar_0_0' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, IsInFirstShow) == 0x000A18, "Member 'ABP_NPC_EnemySentry_Climbin_C::IsInFirstShow' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, ShowUp) == 0x000A20, "Member 'ABP_NPC_EnemySentry_Climbin_C::ShowUp' has a wrong offset!");
static_assert(offsetof(ABP_NPC_EnemySentry_Climbin_C, TempList) == 0x000A30, "Member 'ABP_NPC_EnemySentry_Climbin_C::TempList' has a wrong offset!");
