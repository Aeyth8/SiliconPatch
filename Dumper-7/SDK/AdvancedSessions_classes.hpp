...
{
public:
	bool                                          bCallFriendInterfaceEventsOnPlayerControllers;     // 0x00A0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCallIdentityInterfaceEventsOnPlayerControllers;   // 0x00A1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCallVoiceInterfaceEventsOnPlayerControllers;      // 0x00A2(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableTalkingStatusDelegate;                      // 0x00A3(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A4[0x7C];                                      // 0x00A4(0x007C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAdvancedFriendsGameInstance) == 0x000120, "Wrong size on UAdvancedFriendsGameInstance");
static_assert(offsetof(UAdvancedFriendsGameInstance, bCallFriendInterfaceEventsOnPlayerControllers) == 0x0000A0, "Member 'UAdvancedFriendsGameInstance::bCallFriendInterfaceEventsOnPlayerControllers' has a wrong offset!");
static_assert(offsetof(UAdvancedFriendsGameInstance, bCallIdentityInterfaceEventsOnPlayerControllers) == 0x0000A1, "Member 'UAdvancedFriendsGameInstance::bCallIdentityInterfaceEventsOnPlayerControllers' has a wrong offset!");
static_assert(offsetof(UAdvancedFriendsGameInstance, bCallVoiceInterfaceEventsOnPlayerControllers) == 0x0000A2, "Member 'UAdvancedFriendsGameInstance::bCallVoiceInterfaceEventsOnPlayerControllers' has a wrong offset!");
static_assert(offsetof(UAdvancedFriendsGameInstance, bEnableTalkingStatusDelegate) == 0x0000A3, "Member 'UAdvancedFriendsGameInstance::bEnableTalkingStatusDelegate' has a wrong offset!");
...
static_assert(sizeof(UCancelFindSessionsCallbackProxy) == 0x000070, "Wrong size on UCancelFindSessionsCallbackProxy");
static_assert(offsetof(UCancelFindSessionsCallbackProxy, OnSuccess) == 0x000028, "Member 'UCancelFindSessionsCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UCancelFindSessionsCallbackProxy, OnFailure) == 0x000038, "Member 'UCancelFindSessionsCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UCreateSessionCallbackProxyAdvanced) == 0x0000B0, "Wrong size on UCreateSessionCallbackProxyAdvanced");
static_assert(offsetof(UCreateSessionCallbackProxyAdvanced, OnSuccess) == 0x000028, "Member 'UCreateSessionCallbackProxyAdvanced::OnSuccess' has a wrong offset!");
static_assert(offsetof(UCreateSessionCallbackProxyAdvanced, OnFailure) == 0x000038, "Member 'UCreateSessionCallbackProxyAdvanced::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UEndSessionCallbackProxy) == 0x000070, "Wrong size on UEndSessionCallbackProxy");
static_assert(offsetof(UEndSessionCallbackProxy, OnSuccess) == 0x000028, "Member 'UEndSessionCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UEndSessionCallbackProxy, OnFailure) == 0x000038, "Member 'UEndSessionCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UFindFriendSessionCallbackProxy) == 0x000090, "Wrong size on UFindFriendSessionCallbackProxy");
static_assert(offsetof(UFindFriendSessionCallbackProxy, OnSuccess) == 0x000028, "Member 'UFindFriendSessionCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UFindFriendSessionCallbackProxy, OnFailure) == 0x000038, "Member 'UFindFriendSessionCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UFindSessionsCallbackProxyAdvanced) == 0x0000C8, "Wrong size on UFindSessionsCallbackProxyAdvanced");
static_assert(offsetof(UFindSessionsCallbackProxyAdvanced, OnSuccess) == 0x000028, "Member 'UFindSessionsCallbackProxyAdvanced::OnSuccess' has a wrong offset!");
static_assert(offsetof(UFindSessionsCallbackProxyAdvanced, OnFailure) == 0x000038, "Member 'UFindSessionsCallbackProxyAdvanced::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UGetFriendsCallbackProxy) == 0x000068, "Wrong size on UGetFriendsCallbackProxy");
static_assert(offsetof(UGetFriendsCallbackProxy, OnSuccess) == 0x000028, "Member 'UGetFriendsCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UGetFriendsCallbackProxy, OnFailure) == 0x000038, "Member 'UGetFriendsCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UGetRecentPlayersCallbackProxy) == 0x000088, "Wrong size on UGetRecentPlayersCallbackProxy");
static_assert(offsetof(UGetRecentPlayersCallbackProxy, OnSuccess) == 0x000028, "Member 'UGetRecentPlayersCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UGetRecentPlayersCallbackProxy, OnFailure) == 0x000038, "Member 'UGetRecentPlayersCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UGetUserPrivilegeCallbackProxy) == 0x000078, "Wrong size on UGetUserPrivilegeCallbackProxy");
static_assert(offsetof(UGetUserPrivilegeCallbackProxy, OnSuccess) == 0x000028, "Member 'UGetUserPrivilegeCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(UGetUserPrivilegeCallbackProxy, OnFailure) == 0x000038, "Member 'UGetUserPrivilegeCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(ULoginUserCallbackProxy) == 0x000090, "Wrong size on ULoginUserCallbackProxy");
static_assert(offsetof(ULoginUserCallbackProxy, OnSuccess) == 0x000028, "Member 'ULoginUserCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(ULoginUserCallbackProxy, OnFailure) == 0x000038, "Member 'ULoginUserCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(ULogoutUserCallbackProxy) == 0x000070, "Wrong size on ULogoutUserCallbackProxy");
static_assert(offsetof(ULogoutUserCallbackProxy, OnSuccess) == 0x000028, "Member 'ULogoutUserCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(ULogoutUserCallbackProxy, OnFailure) == 0x000038, "Member 'ULogoutUserCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(USendFriendInviteCallbackProxy) == 0x000088, "Wrong size on USendFriendInviteCallbackProxy");
static_assert(offsetof(USendFriendInviteCallbackProxy, OnSuccess) == 0x000028, "Member 'USendFriendInviteCallbackProxy::OnSuccess' has a wrong offset!");
static_assert(offsetof(USendFriendInviteCallbackProxy, OnFailure) == 0x000038, "Member 'USendFriendInviteCallbackProxy::OnFailure' has a wrong offset!");
...
static_assert(sizeof(UUpdateSessionCallbackProxyAdvanced) == 0x000090, "Wrong size on UUpdateSessionCallbackProxyAdvanced");
static_assert(offsetof(UUpdateSessionCallbackProxyAdvanced, OnSuccess) == 0x000028, "Member 'UUpdateSessionCallbackProxyAdvanced::OnSuccess' has a wrong offset!");
static_assert(offsetof(UUpdateSessionCallbackProxyAdvanced, OnFailure) == 0x000038, "Member 'UUpdateSessionCallbackProxyAdvanced::OnFailure' has a wrong offset!");
