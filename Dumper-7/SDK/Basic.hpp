...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0310D170;
	constexpr int32 AppendString      = 0x0068F920;
	constexpr int32 GNames            = 0x03108F28;
	constexpr int32 GWorld            = 0x031FA098;
	constexpr int32 ProcessEvent      = 0x00819B70;
