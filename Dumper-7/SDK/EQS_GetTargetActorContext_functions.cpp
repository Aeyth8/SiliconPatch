...
#include "EQS_GetTargetActorContext_classes.hpp"
#include "EQS_GetTargetActorContext_parameters.hpp"
...
void UEQS_GetTargetActorContext_C::ProvideSingleActor(class UObject* QuerierObject, class AActor* QuerierActor, class AActor** ResultingActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("EQS_GetTargetActorContext_C", "ProvideSingleActor");

	Params::EQS_GetTargetActorContext_C_ProvideSingleActor Parms{};
