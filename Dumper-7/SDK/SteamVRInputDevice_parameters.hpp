...
struct SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni final
{
public:
...
static_assert(alignof(SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni) == 0x000008, "Wrong alignment on SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni");
static_assert(sizeof(SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni) == 0x000018, "Wrong size on SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni, UserInputFile) == 0x000000, "Member 'SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni::UserInputFile' has a wrong offset!");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni, ReturnValue) == 0x000010, "Member 'SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(SteamVRInputDeviceFunctionLibrary_FindSteamVR_ActionOrigin) == 0x000018, "Wrong size on SteamVRInputDeviceFunctionLibrary_FindSteamVR_ActionOrigin");
...
static_assert(sizeof(SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform) == 0x000C10, "Wrong size on SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform");
...
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform, RightHand) == 0x000600, "Member 'SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform::RightHand' has a wrong offset!");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform, bWithController) == 0x000C00, "Member 'SteamVRInputDeviceFunctionLibrary_GetSkeletalTransform::bWithController' has a wrong offset!");
...
// 0x0018 (0x0018 - 0x0000)
struct SteamVRInputDeviceFunctionLibrary_ShowBindingsUI final
{
public:
	EHand                                         hand;                                              // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(SteamVRInputDeviceFunctionLibrary_ShowBindingsUI) == 0x000004, "Wrong alignment on SteamVRInputDeviceFunctionLibrary_ShowBindingsUI");
static_assert(sizeof(SteamVRInputDeviceFunctionLibrary_ShowBindingsUI) == 0x000018, "Wrong size on SteamVRInputDeviceFunctionLibrary_ShowBindingsUI");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_ShowBindingsUI, hand) == 0x000000, "Member 'SteamVRInputDeviceFunctionLibrary_ShowBindingsUI::hand' has a wrong offset!");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_ShowBindingsUI, ActionSet) == 0x000008, "Member 'SteamVRInputDeviceFunctionLibrary_ShowBindingsUI::ActionSet' has a wrong offset!");
static_assert(offsetof(SteamVRInputDeviceFunctionLibrary_ShowBindingsUI, bShowInVR) == 0x000010, "Member 'SteamVRInputDeviceFunctionLibrary_ShowBindingsUI::bShowInVR' has a wrong offset!");
