...
public:
	...
	uint8                                         Pad_1979[0x7];                                     // 0x1979(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USteamNetConnection) == 0x001980, "Wrong size on USteamNetConnection");
static_assert(offsetof(USteamNetConnection, bIsPassthrough) == 0x001978, "Member 'USteamNetConnection::bIsPassthrough' has a wrong offset!");
...
static_assert(sizeof(USteamNetDriver) == 0x0006E0, "Wrong size on USteamNetDriver");
