...
public:
	...
	int32                                         NumTracks;                                         // 0x0594(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_59C[0x30];                                     // 0x059C(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UGeometryCacheComponent, NumTracks) == 0x000594, "Member 'UGeometryCacheComponent::NumTracks' has a wrong offset!");
static_assert(offsetof(UGeometryCacheComponent, ElapsedTime) == 0x000598, "Member 'UGeometryCacheComponent::ElapsedTime' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_60[0x120];                                     // 0x0060(0x0120)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UGeometryCacheTrackStreamable) == 0x000188, "Wrong size on UGeometryCacheTrackStreamable");
...
static_assert(offsetof(UGeometryCacheTrackStreamable, StartSampleTime) == 0x000180, "Member 'UGeometryCacheTrackStreamable::StartSampleTime' has a wrong offset!");
