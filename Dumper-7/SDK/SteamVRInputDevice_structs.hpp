...
static_assert(sizeof(FSteamVRSkeletonTransform) == 0x000600, "Wrong size on FSteamVRSkeletonTransform");
...
static_assert(offsetof(FSteamVRSkeletonTransform, Bone_Count) == 0x0005D0, "Member 'FSteamVRSkeletonTransform::Bone_Count' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SteamVRInputAnimPose) == 0x000670, "Wrong size on FAnimNode_SteamVRInputAnimPose");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, MotionRange) == 0x000030, "Member 'FAnimNode_SteamVRInputAnimPose::MotionRange' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, hand) == 0x000031, "Member 'FAnimNode_SteamVRInputAnimPose::hand' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, HandSkeleton) == 0x000032, "Member 'FAnimNode_SteamVRInputAnimPose::HandSkeleton' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, Mirror) == 0x000033, "Member 'FAnimNode_SteamVRInputAnimPose::Mirror' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, SteamVRSkeletalTransform) == 0x000040, "Member 'FAnimNode_SteamVRInputAnimPose::SteamVRSkeletalTransform' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRInputAnimPose, UE4RetargettingRefs) == 0x000640, "Member 'FAnimNode_SteamVRInputAnimPose::UE4RetargettingRefs' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SteamVRSetWristTransform) == 0x000060, "Wrong size on FAnimNode_SteamVRSetWristTransform");
static_assert(offsetof(FAnimNode_SteamVRSetWristTransform, ReferencePose) == 0x000030, "Member 'FAnimNode_SteamVRSetWristTransform::ReferencePose' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRSetWristTransform, HandSkeleton) == 0x000040, "Member 'FAnimNode_SteamVRSetWristTransform::HandSkeleton' has a wrong offset!");
static_assert(offsetof(FAnimNode_SteamVRSetWristTransform, TargetPose) == 0x000048, "Member 'FAnimNode_SteamVRSetWristTransform::TargetPose' has a wrong offset!");
...
struct alignas(0x08) FSteamVRInputBindingInfo final
{
public:
...
static_assert(alignof(FSteamVRInputBindingInfo) == 0x000008, "Wrong alignment on FSteamVRInputBindingInfo");
