...
static_assert(sizeof(ULandscapeComponent) == 0x000740, "Wrong size on ULandscapeComponent");
...
static_assert(offsetof(ULandscapeComponent, MaterialIndexToDisabledTessellationMaterial) == 0x0005C0, "Member 'ULandscapeComponent::MaterialIndexToDisabledTessellationMaterial' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, WeightmapLayerAllocations) == 0x0005D0, "Member 'ULandscapeComponent::WeightmapLayerAllocations' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, WeightmapTextures) == 0x0005E0, "Member 'ULandscapeComponent::WeightmapTextures' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, XYOffsetmapTexture) == 0x0005F0, "Member 'ULandscapeComponent::XYOffsetmapTexture' has a wrong offset!");
...
static_assert(offsetof(ULandscapeComponent, HeightmapTexture) == 0x000630, "Member 'ULandscapeComponent::HeightmapTexture' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, CachedLocalBox) == 0x000638, "Member 'ULandscapeComponent::CachedLocalBox' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, CollisionComponent) == 0x000654, "Member 'ULandscapeComponent::CollisionComponent' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, MapBuildDataId) == 0x000670, "Member 'ULandscapeComponent::MapBuildDataId' has a wrong offset!");
static_assert(offsetof(ULandscapeComponent, IrrelevantLights) == 0x000680, "Member 'ULandscapeComponent::IrrelevantLights' has a wrong offset!");
...
static_assert(sizeof(ULandscapeHeightfieldCollisionComponent) == 0x000638, "Wrong size on ULandscapeHeightfieldCollisionComponent");
...
static_assert(offsetof(ULandscapeHeightfieldCollisionComponent, RenderComponent) == 0x0005BC, "Member 'ULandscapeHeightfieldCollisionComponent::RenderComponent' has a wrong offset!");
