...
static_assert(sizeof(UARSessionConfig) == 0x000088, "Wrong size on UARSessionConfig");
...
// Class AugmentedReality.ARPointCloudComponent
// 0x0050 (0x05D0 - 0x0580)
class UARPointCloudComponent final : public UMeshComponent
{
public:
	bool                                          bAutoBindToARSystem;                               // 0x0580(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsVisible;                                        // 0x0581(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_582[0x6];                                      // 0x0582(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVector>                        PointCloud;                                        // 0x0588(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FLinearColor                           PointColor;                                        // 0x0598(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         PointSize;                                         // 0x05A8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBoxSphereBounds                       LocalBounds;                                       // 0x05AC(0x001C)(ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_5C8[0x8];                                      // 0x05C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClearPointCloud();
	void SetIsVisible(bool bNewVisibility);
	void SetPointCloud(const TArray<struct FVector>& Points);
	void SetPointColor(const struct FLinearColor& Color);
	void SetPointSize(float Size);

	TArray<struct FVector> GetPointsInBox(const struct FBox& WorldSpaceBox) const;
	TArray<struct FVector> GetPointsOutsideBox(const struct FBox& WorldSpaceBox) const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ARPointCloudComponent">();
	}
	static class UARPointCloudComponent* GetDefaultObj()
	{
		return GetDefaultObjImpl<UARPointCloudComponent>();
	}
};
static_assert(alignof(UARPointCloudComponent) == 0x000008, "Wrong alignment on UARPointCloudComponent");
static_assert(sizeof(UARPointCloudComponent) == 0x0005D0, "Wrong size on UARPointCloudComponent");
static_assert(offsetof(UARPointCloudComponent, bAutoBindToARSystem) == 0x000580, "Member 'UARPointCloudComponent::bAutoBindToARSystem' has a wrong offset!");
static_assert(offsetof(UARPointCloudComponent, bIsVisible) == 0x000581, "Member 'UARPointCloudComponent::bIsVisible' has a wrong offset!");
static_assert(offsetof(UARPointCloudComponent, PointCloud) == 0x000588, "Member 'UARPointCloudComponent::PointCloud' has a wrong offset!");
static_assert(offsetof(UARPointCloudComponent, PointColor) == 0x000598, "Member 'UARPointCloudComponent::PointColor' has a wrong offset!");
static_assert(offsetof(UARPointCloudComponent, PointSize) == 0x0005A8, "Member 'UARPointCloudComponent::PointSize' has a wrong offset!");
static_assert(offsetof(UARPointCloudComponent, LocalBounds) == 0x0005AC, "Member 'UARPointCloudComponent::LocalBounds' has a wrong offset!");
...
{
public:
	int32                                         BufferSizePerChunk;                                // 0x0410(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_414[0x64];                                     // 0x0414(0x0064)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AARSharedWorldGameMode) == 0x000478, "Wrong size on AARSharedWorldGameMode");
static_assert(offsetof(AARSharedWorldGameMode, BufferSizePerChunk) == 0x000410, "Member 'AARSharedWorldGameMode::BufferSizePerChunk' has a wrong offset!");
...
{
public:
	TArray<uint8>                                 PreviewImageData;                                  // 0x0388(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ARWorldData;                                       // 0x0398(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesTotal;                            // 0x03A8(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesTotal;                                 // 0x03AC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PreviewImageBytesDelivered;                        // 0x03B0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         ARWorldBytesDelivered;                             // 0x03B4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AARSharedWorldGameState) == 0x0003C0, "Wrong size on AARSharedWorldGameState");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageData) == 0x000388, "Member 'AARSharedWorldGameState::PreviewImageData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldData) == 0x000398, "Member 'AARSharedWorldGameState::ARWorldData' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesTotal) == 0x0003A8, "Member 'AARSharedWorldGameState::PreviewImageBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesTotal) == 0x0003AC, "Member 'AARSharedWorldGameState::ARWorldBytesTotal' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, PreviewImageBytesDelivered) == 0x0003B0, "Member 'AARSharedWorldGameState::PreviewImageBytesDelivered' has a wrong offset!");
static_assert(offsetof(AARSharedWorldGameState, ARWorldBytesDelivered) == 0x0003B4, "Member 'AARSharedWorldGameState::ARWorldBytesDelivered' has a wrong offset!");
...
static_assert(sizeof(AARSharedWorldPlayerController) == 0x000680, "Wrong size on AARSharedWorldPlayerController");
...
{
public:
	class UAREnvironmentCaptureProbe*             CaptureProbe;                                      // 0x0338(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AARSkyLight) == 0x000348, "Wrong size on AARSkyLight");
static_assert(offsetof(AARSkyLight, CaptureProbe) == 0x000338, "Member 'AARSkyLight::CaptureProbe' has a wrong offset!");
...
{
public:
	EARTextureType                                TextureType;                                       // 0x00B0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0x3];                                       // 0x00B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Timestamp;                                         // 0x00B4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  ExternalTextureGuid;                               // 0x00B8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector2D                              Size;                                              // 0x00C8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARTexture) == 0x0000D0, "Wrong size on UARTexture");
static_assert(offsetof(UARTexture, TextureType) == 0x0000B0, "Member 'UARTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UARTexture, Timestamp) == 0x0000B4, "Member 'UARTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UARTexture, ExternalTextureGuid) == 0x0000B8, "Member 'UARTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UARTexture, Size) == 0x0000C8, "Member 'UARTexture::Size' has a wrong offset!");
...
static_assert(sizeof(UARTextureCameraImage) == 0x0000D0, "Wrong size on UARTextureCameraImage");
...
{
public:
	EARDepthQuality                               DepthQuality;                                      // 0x00D0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EARDepthAccuracy                              DepthAccuracy;                                     // 0x00D1(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTemporallySmoothed;                             // 0x00D2(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UARTextureCameraDepth) == 0x0000D8, "Wrong size on UARTextureCameraDepth");
static_assert(offsetof(UARTextureCameraDepth, DepthQuality) == 0x0000D0, "Member 'UARTextureCameraDepth::DepthQuality' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, DepthAccuracy) == 0x0000D1, "Member 'UARTextureCameraDepth::DepthAccuracy' has a wrong offset!");
static_assert(offsetof(UARTextureCameraDepth, bIsTemporallySmoothed) == 0x0000D2, "Member 'UARTextureCameraDepth::bIsTemporallySmoothed' has a wrong offset!");
...
static_assert(sizeof(UAREnvironmentCaptureProbeTexture) == 0x000128, "Wrong size on UAREnvironmentCaptureProbeTexture");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, TextureType) == 0x000108, "Member 'UAREnvironmentCaptureProbeTexture::TextureType' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Timestamp) == 0x00010C, "Member 'UAREnvironmentCaptureProbeTexture::Timestamp' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, ExternalTextureGuid) == 0x000110, "Member 'UAREnvironmentCaptureProbeTexture::ExternalTextureGuid' has a wrong offset!");
static_assert(offsetof(UAREnvironmentCaptureProbeTexture, Size) == 0x000120, "Member 'UAREnvironmentCaptureProbeTexture::Size' has a wrong offset!");
...
public:
	...
	class UARCandidateImage*                      DetectedImage;                                     // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
