...
public:
	...
	uint8                                         bFractureEffectOverride : 1;                       // 0x06C8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	UMulticastDelegateProperty_                   OnComponentFracture;                               // 0x06F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_708[0x98];                                     // 0x0708(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UDestructibleComponent, FractureEffects) == 0x0006D0, "Member 'UDestructibleComponent::FractureEffects' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, bEnableHardSleeping) == 0x0006E0, "Member 'UDestructibleComponent::bEnableHardSleeping' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, LargeChunkThreshold) == 0x0006E4, "Member 'UDestructibleComponent::LargeChunkThreshold' has a wrong offset!");
static_assert(offsetof(UDestructibleComponent, OnComponentFracture) == 0x0006F8, "Member 'UDestructibleComponent::OnComponentFracture' has a wrong offset!");
...
static_assert(sizeof(UDestructibleMesh) == 0x000398, "Wrong size on UDestructibleMesh");
static_assert(offsetof(UDestructibleMesh, DefaultDestructibleParameters) == 0x0002F8, "Member 'UDestructibleMesh::DefaultDestructibleParameters' has a wrong offset!");
static_assert(offsetof(UDestructibleMesh, FractureEffects) == 0x000380, "Member 'UDestructibleMesh::FractureEffects' has a wrong offset!");
