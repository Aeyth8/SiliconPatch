...
public:
	...
	uint8                                         Pad_738[0x90];                                     // 0x0738(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMovieSceneSequencePlayer, RootTemplateInstance) == 0x000438, "Member 'UMovieSceneSequencePlayer::RootTemplateInstance' has a wrong offset!");
