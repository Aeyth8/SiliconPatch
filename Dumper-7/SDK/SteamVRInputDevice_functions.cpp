...
bool USteamVRInputDeviceFunctionLibrary::DeleteUserInputIni(class FString* UserInputFile)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("SteamVRInputDeviceFunctionLibrary", "DeleteUserInputIni");

	Params::SteamVRInputDeviceFunctionLibrary_DeleteUserInputIni Parms{};
	...
	if (UserInputFile != nullptr)
		*UserInputFile = std::move(Parms.UserInputFile);
...
void USteamVRInputDeviceFunctionLibrary::ShowBindingsUI(EHand hand, class FName ActionSet, bool bShowInVR)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("SteamVRInputDeviceFunctionLibrary", "ShowBindingsUI");

	Params::SteamVRInputDeviceFunctionLibrary_ShowBindingsUI Parms{};

	Parms.hand = hand;
	Parms.ActionSet = ActionSet;
	Parms.bShowInVR = bShowInVR;
