...
class ABP_Missile_C final : public AAI_Projectile_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_Missile_C;                       // 0x0540(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	void InitMissile(const struct FVector& Velocity, const struct FRotator& Rotation);
...
static_assert(sizeof(ABP_Missile_C) == 0x000580, "Wrong size on ABP_Missile_C");
static_assert(offsetof(ABP_Missile_C, UberGraphFrame_BP_Missile_C) == 0x000540, "Member 'ABP_Missile_C::UberGraphFrame_BP_Missile_C' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, StaticMesh_0) == 0x000548, "Member 'ABP_Missile_C::StaticMesh_0' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, TailFlame) == 0x000550, "Member 'ABP_Missile_C::TailFlame' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, TailSmoke) == 0x000558, "Member 'ABP_Missile_C::TailSmoke' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, ParticleExplosion) == 0x000560, "Member 'ABP_Missile_C::ParticleExplosion' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, HitActor) == 0x000568, "Member 'ABP_Missile_C::HitActor' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, BaseDamge) == 0x000570, "Member 'ABP_Missile_C::BaseDamge' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, ExplosionRadis) == 0x000574, "Member 'ABP_Missile_C::ExplosionRadis' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, DamgeFallingByDistance) == 0x000578, "Member 'ABP_Missile_C::DamgeFallingByDistance' has a wrong offset!");
static_assert(offsetof(ABP_Missile_C, DamgeFallingByBlock) == 0x00057C, "Member 'ABP_Missile_C::DamgeFallingByBlock' has a wrong offset!");
