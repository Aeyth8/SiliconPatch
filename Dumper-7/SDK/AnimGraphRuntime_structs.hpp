...
static_assert(offsetof(FAnimNode_ApplyAdditive, AlphaInputType) == 0x000064, "Member 'FAnimNode_ApplyAdditive::AlphaInputType' has a wrong offset!");
static_assert(offsetof(FAnimNode_ApplyAdditive, bAlphaBoolEnabled) == 0x000065, "Member 'FAnimNode_ApplyAdditive::bAlphaBoolEnabled' has a wrong offset!");
...
{
public:
	uint8                                         Pad_570[0x220];                                    // 0x0570(0x0220)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000790, "Wrong size on FAnimSequencerInstanceProxy");
