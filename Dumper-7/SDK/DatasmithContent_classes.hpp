...
{
public:
	TSet<class FName>                             Layers;                                            // 0x0028(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<class FName>                             Tags;                                              // 0x0078(0x0050)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithActorTemplate) == 0x0000C8, "Wrong size on UDatasmithActorTemplate");
static_assert(offsetof(UDatasmithActorTemplate, Layers) == 0x000028, "Member 'UDatasmithActorTemplate::Layers' has a wrong offset!");
static_assert(offsetof(UDatasmithActorTemplate, Tags) == 0x000078, "Member 'UDatasmithActorTemplate::Tags' has a wrong offset!");
...
static_assert(offsetof(UDatasmithCineCameraComponentTemplate, CurrentFocalLength) == 0x00003C, "Member 'UDatasmithCineCameraComponentTemplate::CurrentFocalLength' has a wrong offset!");
static_assert(offsetof(UDatasmithCineCameraComponentTemplate, CurrentAperture) == 0x000040, "Member 'UDatasmithCineCameraComponentTemplate::CurrentAperture' has a wrong offset!");
...
public:
	...
	int32                                         StaticLightingLOD;                                 // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDatasmithLandscapeTemplate) == 0x000038, "Wrong size on UDatasmithLandscapeTemplate");
static_assert(offsetof(UDatasmithLandscapeTemplate, LandscapeMaterial) == 0x000028, "Member 'UDatasmithLandscapeTemplate::LandscapeMaterial' has a wrong offset!");
static_assert(offsetof(UDatasmithLandscapeTemplate, StaticLightingLOD) == 0x000030, "Member 'UDatasmithLandscapeTemplate::StaticLightingLOD' has a wrong offset!");
